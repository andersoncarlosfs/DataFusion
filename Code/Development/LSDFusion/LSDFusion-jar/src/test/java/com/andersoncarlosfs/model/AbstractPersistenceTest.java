...
public abstract class AbstractPersistenceTest<S extends AbstractEntity<T>, T extends Comparable<T>> {
    ...
    public static void setUpClass() throws Exception {
        ...
        properties.put(JDBC_URL, "jdbc:postgresql://localhost:5432/LSDFusion");
        ...
        persistenceUnits.put("LSDFusionPU", properties);
        ...
        emf = Persistence.createEntityManagerFactory("LSDFusionPU", properties);
    }
