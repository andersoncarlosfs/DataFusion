...
public abstract class AbstractPersistenceTest<S extends AbstractEntity<T>, T extends Comparable<T>> {
    ...
    public static void setUpClass() throws Exception {
        ...
        properties.put(JDBC_URL, "jdbc:postgresql://localhost:5432/LSD_Fusion");
        ...
        persistenceUnits.put("LSD_FusionPU", properties);
        ...
        emf = Persistence.createEntityManagerFactory("LSD_FusionPU", properties);
    }
